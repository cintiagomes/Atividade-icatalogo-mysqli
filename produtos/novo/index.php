...
/*QUERY SQL*/
$sql = "SELECT * FROM icatalogo.tbl_categoria";
        ...
        <form class="form-produto" method="POST" action="../acoes.php" enctype="multipart/form-data">
          ...
          <div class="input-group">
            ...
            <select id="categoria" name="categoria" "">
              ...
              <!-- INICIO DA LISTAGEM DE CATEGORIA VANDAS DO BANCO -->
                <?php
                ...
                ?>
              <!-- FIM DA LISTAGEM DE CATEGORIA VANDAS DO BANCO -->  
          ...
          <button onclick="javascript:window.location.href = '../Produtos/'">Cancelar</button>
